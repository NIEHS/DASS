...
# Edit the bsCollapsePanel function to use h1 tag in title
bsCollapsePanel_h1 <- function(title, ..., value = title, style = NULL) {
  content <- list(...)
  ...
  bsTag <- shiny::tags$div(class = paste0(
    ...
    shiny::tags$h1(class = "panel-title", shiny::tags$a(
...
environment(bsCollapsePanel_h1) <- asNamespace("shinyBS")
...
# Step 1: Select DAs -----
selectda_panel <- bsCollapsePanel_h1(
...
# Step 2: Upload Data -----
uploaddata_panel <- bsCollapsePanel_h1(
...
selectcolumns_panel <- bsCollapsePanel_h1(
...
### hCLAT -----
info_hclat_call_modal <- bsModal_h2(
  id = "hclat_call_modal",
...
info_hclat_mit_modal <- bsModal_h2(
  id = "hclat_mit_modal",
  title = "h-CLAT MIT",
...
### In Silico -----
info_insilico_modal <- bsModal_h2(
  id = "insilico_modal",
...
reviewselection_panel <- bsCollapsePanel_h1(
...
# Step 5: Results -----
results_panel <- bsCollapsePanel_h1(
